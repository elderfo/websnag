...
describe('EndpointCard', () => {
  ...
  it('shows Paused badge when endpoint is inactive', () => {
    render(<EndpointCard endpoint={{ ...mockEndpoint, is_active: false }} />)
  ...
  it('does not render description when empty', () => {
    render(<EndpointCard endpoint={{ ...mockEndpoint, description: '' }} />)
